...
int main() {
    ...
    bool spans = doesSpan(matrix);
    if (spans) {
        cout << "The vectors represented by the rows of the matrix span." << endl;
    } else {
        cout << "The vectors represented by the rows of the matrix do not span." << endl;
    }
